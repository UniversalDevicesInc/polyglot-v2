...
module.exports = {
   ...
   */
  addSubscriptions() {
    config.mqttClient.subscribe('udi/polyglot/connections/#')
  ...
  addSubscription(profileNum) {
    ...
    config.mqttClient.subscribe('udi/polyglot/ns/' + profileNum)
    config.mqttClient.subscribe('udi/polyglot/profile/' + profileNum)
  },

  delSubscription(profileNum) {
    config.mqttClient.unsubscribe('udi/polyglot/ns/' + profileNum)
    config.mqttClient.unsubscribe('udi/polyglot/profile/' + profileNum)
    config.mqttClient.publish('udi/polyglot/connections/' + profileNum, null, { retain: true })
    config.mqttClient.publish('udi/polyglot/ns/' + profileNum, null, {retain: true })
  },
  /**
