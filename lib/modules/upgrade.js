 ...
 */
 ...
 module.exports = {
   ...
   _inProgress: false,
   _filePath: 'https://github.com/Einstein42/udi-polyglotv2/raw/master/binaries/',
   _fileName: {
   ...
   extract(file) {
     ...
     try {
       decompress(file, '.', {
         ...
         let msg = 'Upgrade Complete. Shutting Down in 5 seconds. SystemCTL or LaunchD should restart Polyglot automatically. If not, restart it manually.'
         logger.info(msg)
